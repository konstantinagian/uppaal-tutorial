...
- `Pr[<=100](<> Process.goal)` δηλαδή ποιά είναι η πιθανότητα να φτάσουμε στην τοποθεσία *goal* σε λιγότερες ή 100 χρονικές μονάδες. Παίρνουμε αποτέλεσμα $\ge 0.950056 \ (95\%\  CI)$
