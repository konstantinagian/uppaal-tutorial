...
Θα αναπτύξουμε βήμα προς βήμα ένα μοντέλο ενός απλού συστήματος Internet of Things (IoT) στο UPPAAL. Το σύστημα αποτελείται από Ν συσκευές (devices), οι οποίες δημιουργούν εργασίες προς επεξεργασία (πχ στέλνουν μετρήσεις στο cloud), και έναν κεντρικό Cloud εξυπηρετητή, ο οποίος είναι υπεύθυνος για την εκτέλεσή τους. Κάθε συσκευή λειτουργεί ανεξάρτητα από τις υπόλοιπες, δημιουργώντας περιοδικά νέες εργασίες και αποστέλλοντάς τες στο Cloud. Μετά την ολοκλήρωση της επεξεργασίας, το Cloud επιστρέφει το αποτέλεσμα στην αντίστοιχη συσκευή, η οποία μπορεί στη συνέχεια να δημιουργήσει νέα εργασία. Στόχος του μοντέλου είναι η σταδιακή προσθήκη χαρακτηριστικών που συναντώνται σε πραγματικά συστήματα IoT, όπως χρονικοί περιορισμοί, ουρές αναμονής και μηχανισμοί διαχείρισης πολλαπλών αιτημάτων, παρουσιάζοντας σε κάθε βήμα τις απαραίτητες αλλαγές στη μοντελοποίηση.

## Απλή υλοποίηση χωρίς ουρά

Το σύστημα αποτελείται από Ν IoT συσκευές που επικοινωνούν με ένα Cloud. Αρχικά, οι συσκευές θα έχουν blocking συμπεριφορά, δηλαδή θα περιμένουν από το Cloud να τους απαντήσει πριν συνεχίσουν σε επόμενη εργασία.

Τα μοντέλα της συσκευής και του cloud φαίνονται παρακάτω.
...
Χρειαζόμαστε `2*Ν` κανάλια συγχρονισμού. Ένα κανάλι `submit` μεταξύ κάθε συσκευής και του cloud ώστε να του στέλνει τις εργασίες και ένα κανάλι `complete` από το cloud προς την κάθε συσκευή όπου θα της επιστρέφει ότι ολοκληρώθηκε η επεξεργασία της εργασίας.
